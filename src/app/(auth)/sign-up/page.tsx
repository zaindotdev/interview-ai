            ...
            <Card className={"max-w-md w-full"}>
                ...
                <CardFooter className='p-4 space-y-4 flex-col'>
                    ...
                    <Button onClick={handleGithubSignIn} className='w-full cursor-pointer' variant={"secondary"}>
                        {githubLoading ? <Loader2 className='animate-spin' /> : <i className="ri-github-fill" />} Sign Up With Github
                    </Button>
                    <Button onClick={handleGoogleSignIn} className='w-full cursor-pointer' variant={"outline"}>
                        {googleLoading ? <Loader2 className='animate-spin' /> : <i className="ri-google-fill" />} Sign Up With Google
                    </Button>
                </CardFooter>
            </Card>
        </section>
